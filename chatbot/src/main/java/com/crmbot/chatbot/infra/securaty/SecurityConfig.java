...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .requestMatchers("/api/admin", "/sendData", "/getPedidos", "/api/pedidos/**", "/GetNumero", "/SaiuPraEntrega","/GetEstoque","/PostEstoque","/total","/h2-console/**").permitAll() // Adicionando o novo endpoint/ Permite o acesso ao endpoint de criação de admin
